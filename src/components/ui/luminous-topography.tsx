...
export interface LuminousTopographyProps
...
function normalizeFocals(
  focalPoint: LuminousTopographyProps["focalPoint"],
): FocalPx[] {
  ...
  return (
    ...
    >
      ...
      >
          ...
          <defs>
            ...
            >
              <stop
                offset="0%"
                stopColor={accent}
                stopOpacity={round1(0.16 * intensity)}
              />
              <stop
                offset="55%"
                stopColor={accent}
                stopOpacity={round1(0.05 * intensity)}
              />
            ...
            >
              ...
              {interactive ? (
                <ellipse
                  ...
                  style={{
                    transform:
                      "translate(calc(var(--lt-cx, 600) * 1px), calc(var(--lt-cy, 380) * 1px))",
                  }}
                />
              ) : null}
            </mask>
        ...
        {/* biome-ignore lint/security/noDangerouslySetInnerHtml: scoped animation keyframes */}
...
export function LuminousTopography(props: LuminousTopographyProps) {
  return (
    <>
      {/* biome-ignore lint/security/noDangerouslySetInnerHtml: design tokens */}
